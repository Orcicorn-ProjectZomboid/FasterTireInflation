...
function ISVehiclePartMenu.onInflateTire(playerObj, part)
	...
	local maxTime = math.ceil(psiTarget - part:getContainerContentAmount()) * 50
...
function ISVehiclePartMenu.onDeflateTire(playerObj, part)
	...
	ISTimedActionQueue.add(ISDeflateTire:new(playerObj, part, 0, (part:getContainerContentAmount() - 0) * 25))
end
